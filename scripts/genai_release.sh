...
# Example: ./genai_release.sh 1.0.2 RLS-99999 2026-07-21
# Dry-run: ./genai_release.sh --dry-run 1.0.2 RLS-99999 2026-07-21
# No-commit: ./genai_release.sh --no-commit 1.0.2 RLS-99999 2026-07-21
################################################################################
...
if [ "$#" -ne 3 ]; then
  ...
  echo "  release_date  - Release date in YYYY-MM-DD format (e.g., 2026-07-21)"
  echo ""
  echo "Options:"
  ...
  echo ""
  echo "Examples:"
  echo "  $0 1.0.2 RLS-99999 2026-07-21"
  echo "  $0 --dry-run 1.0.2 RLS-99999 2026-07-21"
  echo "  $0 --no-commit 1.0.2 RLS-99999 2026-07-21"
    echo ""
    exit 1
fi
...
echo "GenAI (AI Authoring Rules) Component Catalog Release"
echo "====================================================="
if [ $DRY_RUN -eq 1 ]; then
    echo "[DRY-RUN MODE]"
    echo ""
...
if [ $DRY_RUN -eq 0 ]; then
    ...
    echo "./genai_release.sh $VERSION $WORK_ITEM $RELEASE_DATE"
fi
echo ""
